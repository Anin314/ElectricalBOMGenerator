...
class QuantityAssignDialog(BaseDialog):
    def __init__(self, parent, element_name, part_number, default_prefab=0, default_spare=0):
        self.element_name = element_name
        self.part_number = part_number
        self.default_prefab = default_prefab
        self.default_spare = default_spare
        self.result = None
    ...
    def setup_ui(self):
        ...
        self.prefab_var = tk.IntVar(value=self.default_prefab)
        ...
        self.spare_var = tk.IntVar(value=self.default_spare)
